...
export default function Home() {
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      {/* hero section div */}
      <section>
        <div className="flex flex-col lg:flex-row w-full h-max lg:h-[483px] xl:h-[563px] bg-[#F2F0F1]">


          {/* top / left side */}
          <div className="h-[50%] w-full md:h-[40%] lg:h-full lg:w-1/2 flex flex-col justify-start">
            {/* introduction */}
            <div className="w-full h-full flex flex-col justify-center px-4 pt-5 lg:px-10 lg:py-2">
              ...
              md:text-3xl md:text-center lg:text-left lg:text-4xl xl:text-6xl xl:px-8 xl:leading-[63px]`}
              >
                find clothes <span className='pl-1 xl:pl-3 lg:pl-4'>that matches</span> your style
              </h1>
              <p className="text-sm lg:mt-6 text-gray-500 md:text-lg lg:text-base xl:text-lg xl:pl-9">
                Browse through our diverse range of meticulously crafted garments, designed to bring out your
                individuality and cater to your sense of style.
              </p>
              <button className="bg-black text-white px-6 py-2 rounded-3xl mx-1 mt-2 lg:mt-6 text-sans 
            ...
            <div className="w-full h-[35%] lg:hidden">
              ...
              <div className="w-full h-14 flex flex-row pt-2">
                <div className="text-center h-full w-1/2 border-r-[1px] md:border-r-2">
                  ...
                  <p className="text-sm pl-2 text-gray-500">International Brands</p>
                </div>
                <div className="text-center h-full w-1/2">
                  <h1 className={`${styles.fontSatoshi} font-bold`}>2,000+</h1>
                  <p className="text-sm pl-2 text-gray-500">High-Quality Products</p>
                </div>
              </div>
      ...
      <section id='new-arrivals'>
        ...
        border-gray-200">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl uppercase font-extrabold text-black my-20 text-center">New Arrivals</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-3/4 bg-gray-20 h-[300px] p-4 overflow-hidden mx-auto">
                <img src="/images/shirt1.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-2xl " />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">T-shirt with Tape Details</h3>
                {/* stars */}
                ...
                <div className="w-full flex justify-around items-center mb-3">
                  <Link href={"/productDetails"} className='capitalize text-gray-400 border-2 text-center w-fit px-2 py-1
                  rounded-2xl lg:hover:bg-gray-300 lg:hover:px-4 transition-all lg:hover:text-black lg:hover:font-bold'>view details</Link>
                </div>
              </div>
            ...
            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-2/3 bg-gray-20 h-[300px] p-4 overflow-hidden mx-auto">
                <img src="/images/pent1.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-2xl " />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">Skinny Fit Jeans</h3>
                {/* stars */}
                <div className="flex space-x-2">
                  <svg className="w-4 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div className="flex  items-center space-x-2">
                  ...
                  <h1 className='text-gray-400 text-xl font-bold line-through'>$260</h1>
            ...
            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-2/3 bg-gray-20 h-[295px] p-4 overflow-hidden mx-auto">
                <img src="/images/shirt2.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-2xl " />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">Checkered Shirt</h3>
                {/* stars */}
                <div className="flex space-x-2">
                  <svg className="w-4 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-2/3 bg-gray-20 h-[290px] p-4 overflow-hidden mx-auto">
                <img src="/images/shirt3.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-2xl " />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">Sleeve Striped T-shirt</h3>
                {/* stars */}
                <div className="flex space-x-2">
                  <svg className="w-4 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
          ...
          <div className="text-center mt-10 mb-14">
            <button className='text-xl border-2 border-gray-400 px-20 rounded-3xl py-[9px] text-center 
      ...
      <section>
        ...
        <div className="font-[sans-serif] py-4 mx-auto lg:max-w-[89%] sm:max-w-full">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl uppercase font-extrabold text-black my-16 text-center">Top Selling</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">

            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-2/3 bg-gray-20 h-[290px] p-4 overflow-hidden mx-auto">
                <img src="/images/shirt4.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-2xl" />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">Vertical Striped Shirt</h3>
                {/* stars */}
                <div className="flex space-x-2">
                  <svg className="w-4 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div className="flex  items-center space-x-2">
                  ...
                  <h1 className='text-gray-400 text-xl font-bold line-through'>$232</h1>
                  <h1 className='bg-gray-200 text-red-600 px-2 rounded-xl text-sm'>-20%</h1>
                </div>
            ...
            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-2/3 bg-gray-20 h-[290px] p-4 overflow-hidden mx-auto">
                <img src="/images/shirt5.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-2xl " />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">Courage Graphic T-shirt</h3>
                {/* stars */}
                <div className="flex space-x-2">
                  <svg className="w-4 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-2/3 bg-gray-20 h-[290px] p-4 overflow-hidden mx-auto">
                <img src="/images/shorts.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-2xl " />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">Loose Fit Bermuda Shorts</h3>
                {/* stars */}
                <div className="flex space-x-2">
                  <svg className="w-4 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div className="overflow-hidden hover:shadow-md hover:rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="w-2/3 bg-gray-20 h-[300px] p-4 overflow-hidden mx-auto">
                <img src="/images/pent2.png" alt="Product 1"
                  className="h-full w-full object-cover rounded-[12px] " />
              </div>

              <div className="pl-7 xl:pl-16 bg-white">
                <h3 className="text-xl font-bold text-black">Faded Skinny Jeans</h3>
                {/* stars */}
                <div className="flex space-x-2">
                  <svg className="w-4 fill-[#facc15]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
      ...
      <div className="bg-[#F0F0F0] mt-16 w-[90%] lg:w-[95%] h-fit rounded-[20px] mx-auto mb-10 flex flex-col items-center">
        ...
        <div className="uppercase font-extrabold text-2xl md:text-3xl
        ...
        w-full h-full space-y-5 mb-4 lg:space-x-3">
          <img src="/images/casual-image.png" alt="image" className="w-[80%] md:w-[50%] lg:w-[30%]" />
          <img src="/images/formal-image.png" alt="image" className="w-[90%] md:w-[60%] lg:w-[48%]" />
        </div>

        <div className="flex justify-center items-center flex-col lg:flex-row
        w-full h-full space-y-5 mb-4 lg:space-x-3">
          <img src="/images/party.png" alt="image" className="w-[90%] md:w-[60% lg:w-[40%]" />
          <img src="/images/gym.png" alt="image" className="w-[90%] md:w-[50%] lg:w-[20%]" />
        </div>
      </div>
      ...
      <div className="w-full h-fit flex flex-col flex-wrap">
        ...
        <div className="w-full flex items-end">
          ...
          <div className="w-2/3 pl-3 ">
            <h1 className='uppercase text-2xl md:text-3xl lg:text-4xl lg:pl-8 font-extrabold font-[sans-serif]'>our happy customers</h1>
          </div>
        ...
        <div className="flex flex-col lg:flex-row mb-16">
          <Feedback name="Sarah M." para="I'm blown away by the quality and style of the clothes I received
          from Shop.co. From casual wear to elegant dresses, every piece I've bought has exceeded my
          expectations." />

          <Feedback name="Alex K." para="Finding clothes that align with my personal style used to be a
          ...
          <Feedback name="James L." para="As someone who's always on the lookout for unique fashion pieces,
