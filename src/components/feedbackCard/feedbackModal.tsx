...
export default function FeedbackModal({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        onSubmit({ Name, description, starsNumbers });
    ...
    return (
        <div className="fixed z-50 inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg p-10 w-[90%] md:w-2/3 lg:w-1/2">
                <h2 className="text-3xl mb-4 text-center font-bold">Submit Feedback</h2>
