    ...
    return (
        <div className="bg-white w-full h-24 xl:h-28 ">
            ...
            <div className="relative h-[38px] w-full bg-black flex justify-center items-center 2xl:py-5">
                ...
                <div className="hidden absolute top-1/2 right-3 transform -translate-y-1/2 w-[20px]
            ...
            <nav className='h-[calc(100% - 38px)] w-full flex items-center justify-between xl:py-2 2xl:py-2'>
                <div className="px-1 flex items-center">
                    ...
                    <div className="flex ">
                        ...
                        <span className="px-3 py-2">
                            <Link href={"/"}>
                                <h1 className={`${poppinsFont.className} uppercase font-bold text-[25px] lg:px-4
                    ...
                    <div className="hidden lg:flex items-center justify-center gap-4 lg:px-4 lg:gap-7 xl:px-9
                    xl:text-xl 2xl:px-3">
                        <div className="flex">
                            <Link href="">Shop</Link>
                ...
                <div className="px-3 flex">
                    <form className="hidden lg:block relative">
                        ...
                        />
                        <i className="ri-search-line text-xl absolute left-3 top-1/2 transform
                        -translate-y-1/2 text-gray-600"></i>
                    </form>
                    <div className="">
                        ...
                        <i className="ri-user-line text-xl px-[1.9px] py-[1px] font-bold border-[3px]
                        border-black w-8 h-8 rounded-2xl lg:mr-4 xl:mr-16 xl:text-2xl"></i>
                    </div>
                </div>
