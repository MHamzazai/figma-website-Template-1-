...
export default function MenuToggler() {
  ...
  return (
    <div className="lg:hidden">
      <i
        className={`${menuOpen ? "ri-close-large-line" : "ri-menu-line"} text-black text-2xl font-bold py-[14px] pl-2`} // conditionally render the icon
        onClick={menuToggler}
      ></i>
      <div className={`${menuOpen ? "block absolute w-full mt-4" : "hidden"}`}>
        <div className="flex flex-col justify-center items-center gap-4 bg-red-100 rounded-b-lg py-6 border-b-2 shadow-md">
          ...
          <div className="">
            <Link href="#new-arrivals" className="text-xl font-bold" onClick={closeMenu}>
              New Arrivals
            </Link>
          </div>
          <div className="">
